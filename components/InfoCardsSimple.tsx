...
const Card: React.FC<CardProps> = ({ title, text, index }) => (
  <div className="bg-white p-6 rounded-lg shadow-md transition-all duration-300 hover:shadow-lg border-l-4 border-[#FFD539]">
    ...
    <p className="text-gray-600 ml-11">{text}</p>
  </div>
)

export default function InfoCardsSimple() {
  const cards = [
